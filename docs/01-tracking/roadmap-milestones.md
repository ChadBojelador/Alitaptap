# Hackathon Milestones (10-Day)

## M0 (0-6h): Scope Lock
- Finalize MVP scope and flow
- Freeze core entities and endpoint list

## M1 (6-24h): Foundations ✅
- App shell + API skeleton + Firebase setup
- Role model and auth decisions

Evidence:
- [M1 Foundations Checklist](m1-foundations-checklist.md)
