...
| T-03 | Map validated issues in app | Civic Intelligence | M2 | Team | P0 | Done | 2026-04-19 | 2026-04-19 | T-02 | OpenStreetMap pins render from API data, submit form works | apps/mobile_flutter/lib/features/civic_intelligence/ |
