    ...
    <div className="legal-page-container">
      ...
      <section className="legal-content">
        <div className="legal-block">
          ...
          <p>Last updated: January 1, 2026. Please read these Terms and Conditions carefully before using the IThink platform. By accessing or using IThink, you confirm that you are at least 13 years of age, that you have read and understood these terms, and that you agree to be bound by them. If you do not agree, you must discontinue use of the platform immediately.</p>

          <h3>1. Acceptance of Terms</h3>
          <p>By creating an account or using any part of the IThink service, you enter into a legally binding agreement with IThink. These terms apply to all users, including visitors, registered users, researchers, students, and professionals. IThink reserves the right to update or modify these terms at any time. Continued use of the platform after changes are posted constitutes your acceptance of the revised terms. We recommend reviewing these terms periodically to stay informed of any updates.</p>

          <h3>2. Use of the Platform</h3>
          <p>IThink grants you a limited, non-exclusive, non-transferable license to access and use the platform for personal, educational, or professional purposes. You agree not to use IThink to generate, distribute, or promote false, misleading, or harmful content. You may not attempt to reverse-engineer, scrape, or exploit the platform's AI systems. Any automated access, data harvesting, or unauthorized API usage is strictly prohibited and may result in immediate account termination without refund.</p>

          <h3>3. User Accounts</h3>
          <p>You are responsible for maintaining the confidentiality of your account credentials. You agree to notify IThink immediately of any unauthorized use of your account. IThink is not liable for any loss or damage arising from your failure to protect your login information. Each user may only maintain one active account. Creating multiple accounts to circumvent restrictions or bans is a violation of these terms and may result in permanent suspension of all associated accounts.</p>

          <h3>4. Intellectual Property</h3>
          <p>All content, features, and functionality on IThink — including but not limited to text, graphics, logos, AI models, and software — are the exclusive property of IThink and are protected by applicable intellectual property laws. You may not copy, reproduce, distribute, or create derivative works from any part of the platform without prior written consent from IThink. Content you create using IThink remains yours, but you grant IThink a non-exclusive, royalty-free license to use it for improving our services and training our models.</p>

          <h3>5. Prohibited Conduct</h3>
          <p>You agree not to engage in any conduct that violates any applicable law or regulation, infringes on the rights of others, transmits spam, malware, or harmful code, impersonates any person or entity, or interferes with the proper functioning of the platform. You may not attempt to gain unauthorized access to any part of IThink's systems, databases, or infrastructure. Violations may result in immediate suspension or permanent termination of your account without notice or liability to IThink.</p>

          <h3>6. AI-Generated Content Disclaimer</h3>
          <p>IThink uses artificial intelligence to assist users in analyzing claims, validating sources, and scoring credibility. While we strive for accuracy, AI-generated analysis is not infallible and should not be treated as definitive legal, medical, scientific, or professional advice. Users are responsible for independently verifying critical information through authoritative sources before making decisions based on IThink's output. IThink disclaims all liability for decisions made based solely on AI-generated results.</p>

          <h3>7. Disclaimer of Warranties</h3>
          <p>IThink is provided on an "as is" and "as available" basis without warranties of any kind, either express or implied. We do not warrant that the platform will be uninterrupted, error-free, or completely accurate at all times. We make no guarantees regarding the reliability, timeliness, or completeness of any content or analysis provided through the platform. Your use of IThink is entirely at your own risk.</p>

          <h3>8. Limitation of Liability</h3>
          <p>To the fullest extent permitted by law, IThink shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of or inability to use the platform. This includes loss of data, loss of profits, reputational harm, or any other tangible or intangible losses, even if IThink has been advised of the possibility of such damages. Our total liability to you for any claim shall not exceed the amount you paid to IThink in the twelve months preceding the claim.</p>

          <h3>9. Termination</h3>
          <p>IThink reserves the right to suspend or terminate your access to the platform at any time, with or without cause, and with or without notice. Upon termination, your right to use the platform ceases immediately and any data associated with your account may be deleted. Provisions of these terms that by their nature should survive termination shall survive, including ownership provisions, warranty disclaimers, indemnification obligations, and limitations of liability.</p>

          <h3>10. Governing Law</h3>
          <p>These Terms and Conditions shall be governed by and construed in accordance with the laws of the jurisdiction in which IThink operates, without regard to its conflict of law provisions. Any disputes arising under these terms shall first be attempted to be resolved through good-faith negotiation. If unresolved, disputes shall be submitted to binding arbitration or the courts of the applicable jurisdiction, and you waive any right to a jury trial in connection with such disputes.</p>
        </div>

        <div className="legal-block">
          <h2>Privacy Policy</h2>
          <p>Last updated: January 1, 2026. Your privacy is important to us. This Privacy Policy explains how IThink collects, uses, stores, and protects your personal information when you use our platform. By using IThink, you consent to the data practices described in this policy. We are committed to being transparent about how we handle your data and giving you meaningful control over your information.</p>
      ...
      <section className="signup-cta-section">
        <div className="signup-header">
          <div className="logo-icon-large">
            <img src={logo} alt="IThink Logo" className="ithink-logo-img" />
          </div>
